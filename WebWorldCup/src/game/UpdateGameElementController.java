...
//완
@WebServlet("/game/updateelement")
public class UpdateGameElementController extends HttpServlet {
private static final int MAXIMUM_FILE_SIZE = 5 * 1024 * 1024;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int elementIdx = Integer.parseInt(multi.getParameter("elementIdx"));
		...
		dao.updateElementInfo(elementInfo);
